...
import ec.edu.espe.DesignPattern.util.JsonFileAdministrator;
...
public class FrmSortApp extends javax.swing.JFrame {
    ...
    private void btncalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btncalActionPerformed
        ...
        saveData(numbers, "Data.json");
        
    }//GEN-LAST:event_btncalActionPerformed

    private void saveData(int [] data, String nameFile){
        JsonFileAdministrator jsonFileAdministrator = new JsonFileAdministrator();
        jsonFileAdministrator.addToFile(data,nameFile);
    }
